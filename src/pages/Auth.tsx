...
export default function Auth() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!signupFullName.trim()) throw new Error('Full name is required');
      if (!signupDesignation) throw new Error('Please select a designation');
    } catch (err) {
      if (err instanceof z.ZodError) {
        toast({
          title: 'Validation Error',
    ...
    setIsLoading(true);
    const { error } = await signUp(signupEmail, signupPassword, signupFullName, signupDesignation);
    setIsLoading(false);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/30 p-4">
      <div className="w-full max-w-md">
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          By continuing, you agree to BuildFlow's Terms of Service and Privacy Policy.
        </p>
      </div>
    </div>
  );
